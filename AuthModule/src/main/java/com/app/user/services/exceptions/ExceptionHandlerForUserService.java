...
import com.app.user.services.APIResponse;
import com.app.user.services.CartServiceException;
...
public class ExceptionHandlerForUserService {
    ...
    public ResponseEntity<APIResponse> myCartServiceException(CartServiceException e) {
        APIResponse res = new APIResponse(e.getMessage(), false);
